 ...
 * Generated for Laravel 5.8.11 on 2019-04-11 14:40:47.
 *
...
namespace Spatie\ResponseCache\Facades { 
    ...
    class ResponseCache {
         ...
         * @static 
         */ 
        public static function cacheResponse($request, $response, $lifetimeInSeconds = null)
        {
                        /** @var \Spatie\ResponseCache\ResponseCache $instance */
                        return $instance->cacheResponse($request, $response, $lifetimeInSeconds);
        }
