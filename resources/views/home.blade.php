...
@section('banner')
    <div class="jumbotron jumbotron-fluid top-banner top-banner--main" style="background-image: url('{{ $page->section_image_url }};'">
...
<ol class="list-group banners-group mb-5">
    <li class="list-group-item banner" style="background-image: url('{{ $page->section_image_url }};'">
